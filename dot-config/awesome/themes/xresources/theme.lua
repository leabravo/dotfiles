...
local theme = dofile(themes_path.."/themes/default/theme.lua")
...
theme.bg_urgent     = xrdb.foreground
theme.bg_minimize   = xrdb.bg_normal
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = xrdb.foreground
theme.fg_focus      = theme.bg_urgent
theme.fg_urgent     = theme.bg_normal
theme.fg_minimize   = theme.bg_urgent
...
theme = theme_assets.recolor_layout(theme, theme.bg_urgent)
